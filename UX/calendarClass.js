          ...
          // loop for all events for day [m][d]
            ...
            */
            ...
            if (typeof(nodeName) === "string") {
              ...
              html += `<p>${editButton}<a  href="/app.html?p=events&e=${edgeName}&d=${app.format.getISO(start)}${user}" target="_blank" class="${repeat_class}">${this.graph.nodes[nodeName].text[0][2]}</a></p>`
            } else {
